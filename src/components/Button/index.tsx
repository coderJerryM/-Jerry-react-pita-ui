...
type NativeButtonProps = IButtonProps & Omit<React.ButtonHTMLAttributes<HTMLElement>, 'type'>
type AnchorButtonProps = IButtonProps & Omit<React.AnchorHTMLAttributes<HTMLElement>, 'type'>
